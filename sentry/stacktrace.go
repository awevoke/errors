...
// ReportableStackTrace aliases the type of the same name in the sentry-go
...
//   - errors generated with WithStack() in github.com/cockroachdb/errors/withstack,
