...
func (m *MarkPayload) CloneVT() *MarkPayload {
	if m == nil {
		return (*MarkPayload)(nil)
	}
	r := new(MarkPayload)
	r.Msg = m.Msg
	if rhs := m.Types; rhs != nil {
		tmpContainer := make([]*ErrorTypeMark, len(rhs))
		for k, v := range rhs {
...
func (m *MarkPayload) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (this *MarkPayload) EqualVT(that *MarkPayload) bool {
	if this == that {
		return true
...
func (this *MarkPayload) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*MarkPayload)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (m *MarkPayload) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *MarkPayload) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MarkPayload) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *MarkPayload) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MarkPayload) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
